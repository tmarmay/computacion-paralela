# 0 "tiny_md.c"
# 1 "/users/cp2025/cp2025_093/lab3/lab1//"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 145 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
#pragma omp declare simd notinbranch
# 145 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
...
# 148 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
#pragma omp declare simd notinbranch
# 148 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
...
# 162 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
#pragma omp declare simd notinbranch
# 162 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
...
# 167 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
#pragma omp declare simd notinbranch
# 167 "/usr/include/x86_64-linux-gnu/bits/mathcalls.h" 3 4
...
# 11 "tiny_md.c"
typedef struct {
    double r[(3 * 1372)] __attribute__((aligned(64)));
    double v[(3 * 1372)] __attribute__((aligned(64)));
    double f[(3 * 1372)] __attribute__((aligned(64)));
} Particles;
...
# 35 "tiny_md.c"
    ...
    for (int m = 0; m < 9; m++) {
        Rhob = Rho;
        Rho = 1.2 - 0.1 * (double)m;
        cell_V = (double)1372 / Rho;
        cell_L = cbrt(cell_V);
        tail = 16.0 * 
# 50 "tiny_md.c" 3 4
